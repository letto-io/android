...
public class ActPresentationDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_presentation_details);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(ActPresentationDetails.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

                    if (ActivityCompat.shouldShowRequestPermissionRationale(ActPresentationDetails.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                        ...
                        ActivityCompat.requestPermissions(ActPresentationDetails.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_PERMISSIONS_UPLOAD);
                    }
                } else {
                    openFileManager();
                }
    ...
    private void callDialog(String message, final String[] permissions, final int requestCode) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ActPresentationDetails.this, R.style.AppCompatAlertDialogStyle);
        builder.setMessage(message);
        builder.setPositiveButton(R.string.dialog_confirm, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ActivityCompat.requestPermissions(ActPresentationDetails.this, permissions, requestCode);
            }
        });
    ...
    private void attemptUploadMaterial(Intent data) {
        ...
        if (ContextCompat.checkSelfPermission(ActPresentationDetails.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED ||
                ContextCompat.checkSelfPermission(ActPresentationDetails.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

            if (ActivityCompat.shouldShowRequestPermissionRationale(ActPresentationDetails.this, Manifest.permission.READ_EXTERNAL_STORAGE) ||
                    ActivityCompat.shouldShowRequestPermissionRationale(ActPresentationDetails.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                ActivityCompat.requestPermissions(ActPresentationDetails.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_PERMISSIONS_UPLOAD);
            }
        } else {
                /*
            ...
            final EditText inputName = new EditText(ActPresentationDetails.this);
            ...
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(ActPresentationDetails.this, R.style.AppCompatAlertDialogStyle);
